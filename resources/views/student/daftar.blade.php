                    ...
                    <div class="col">
                        <div class="card h-100 shadow" style="border-radius : 1rem">
                            ...
                            <div class="card-footer text-center">
                                <a href="{{ url('/student/course') }}" class="btn btn-info text-white">Enroll</a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 shadow " style="border-radius : 1rem">
                            ...
                            <div class="card-footer text-center">
                                <a href="{{ url('/student/seminar') }}" class="btn btn-info text-white">Enroll</a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 shadow" style=" border-radius : 1rem">
                            ...
                            <div class="card-footer text-center">
                                <a href="{{ url('/student/certification') }}" class="btn btn-info text-white">Enroll</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card h-100 shadow" style="border-radius : 1rem  ">
                            ...
                            <div class="card-footer text-center">
                                <a href="{{ url('/student/vacancy') }}" class="btn btn-info text-white">show</a>
                            </div>
                        </div>
                    </div>
                </div>
